...
for(let index = 0; index < 8; index++){
  ...
  describe(`Subscription Funnel for ${boxType} size ${size[index]}`, () => {
    ...
    // const naturlMixedColors = '#eby-subscriptionColor22'; only-neutrals
    const naturalColors = '#allPrefGroupChoiceColors label[for="only-neutrals"]'
    const naturlMixedColors = '#allPrefGroupChoiceColors label[for="mixed-colors"]'
